...
function DashboardPage() {
  ...
  return (
    <div className='flex-1 pb-10'>
      ...
      {/* ROW 1: Net Worth Chart (2/3) + Net Worth Breakdown (1/3) — same height */}
      <div className='grid gap-6 lg:grid-cols-3 items-stretch mb-6'>
        {/* Net Worth Chart — flex column so CardContent can grow */}
      ...
      {/* ROW 2: Monthly Spending (2/3) + Spending by Category (1/3) */}
      <div className='grid gap-6 lg:grid-cols-3 items-stretch mb-6'>
        ...
        <Card className='shadow-sm border-gray-100'>
          <CardHeader className='pb-2'>
            <CardTitle className='text-base font-semibold text-gray-700'>Spending by Category</CardTitle>
          </CardHeader>
          <CardContent>
            {!categoryBreakdown || categoryBreakdown.length === 0 ? (
              <div className='py-8 text-center text-sm text-gray-400'>No spending data yet</div>
            ) : (
              <>
                ...
                <div className='space-y-2 mt-1'>
                  {categoryBreakdown.map((cat, i) => {
                    const pct = categoryTotal > 0 ? ((cat.value / categoryTotal) * 100).toFixed(1) : '0';
                    return (
                      <div key={cat.name} className='flex items-center justify-between text-sm'>
                        ...
                        <div className='flex items-center gap-2 shrink-0 ml-2'>
                          ...
                          <span className='font-medium text-gray-800 tabular-nums'>{formatCurrency(cat.value)}</span>
                        </div>
                      </div>
                    );
                  })}
      ...
      {/* ROW 3: Recent Transactions (2/3) + Accounts (1/3) */}
