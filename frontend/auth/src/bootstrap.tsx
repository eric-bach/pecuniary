...
const mount = (el: any, { onNavigate, onSignIn, defaultHistory, initialPath }: any) => {
  ...
  ReactDOM.render(<App onSignIn={(user: string, password: string) => onSignIn(user, password)} history={history} />, el);
