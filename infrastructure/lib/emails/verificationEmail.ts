const VERIFICATION_EMAIL_TEMPLATE = `<!DOCTYPE html>
    <html>
      <head>
        <title>Pecuniary - Verify your new account</title>
      ...
      <body style="background-color: #e1e1e1; margin: 0 !important; padding: 0 !important">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <!-- LOGO -->
          <tr>
            <td bgcolor="#428bff" align="center">
          ...
          <tr>
            <td bgcolor="#428bff" align="center" style="padding: 0px 10px 0px 10px">
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                <tr>
                  <td
                    bgcolor="#ffffff"
            ...
            <td bgcolor="#e1e1e1" align="center" style="padding: 0px 10px 0px 10px">
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                <tr>
                  ...
                  >
                    <p style="margin: 0">
                      We're excited to have you get started. First, you need to confirm your account. Just click the {##Verify Email##} link.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td
                    ...
                    "
                  >
                    <p style="margin: 0">Thanks,<br />Pecuniary Team</p>
                  </td>
                </tr>
              </table>
            </td>
